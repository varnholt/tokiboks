...
{
   return json_str(_credentials_json, "wifi_ssid");
}
String config_store_wifi_password()
{
   return json_str(_credentials_json, "wifi_password");
}
String config_store_admin_username()
{
   return json_str(_credentials_json, "admin_username");
}
String config_store_admin_password()
{
   return json_str(_credentials_json, "admin_password");
}
